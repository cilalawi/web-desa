      ...
      <div className="mt-8 grid gap-6 lg:grid-cols-[0.75fr_1.25fr]">
        <Card className="h-fit border-emerald-900/10 bg-emerald-900 text-white shadow-lg shadow-emerald-900/15">
          <CardContent className="p-6">
            <p className="text-xs font-bold uppercase tracking-[0.2em] text-lime-200">Alur Pengaduan</p>
            <ol className="mt-5 space-y-4 text-sm leading-6 text-emerald-50/85">
          ...
          {isSent ? (
            <Card className="mb-6 border-emerald-900/10 bg-lime-50 shadow-sm">
              <CardContent className="p-6">
                ...
                <p className="mt-2 text-sm text-emerald-950/65">Admin desa dapat meninjau laporan dari panel pengelolaan.</p>
              </CardContent>
            </Card>
          ) : null}
          <Card className="border-emerald-900/10 bg-white shadow-sm shadow-emerald-900/5">
            <CardContent className="p-6">
              <form action={createComplaint} className="grid gap-5">
                {fields.map((field) => (
