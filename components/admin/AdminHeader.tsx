...
export function AdminHeader() {
  return (
    <header className="sticky top-0 z-40 flex min-h-18 items-center justify-between gap-3 border-b border-emerald-900/10 bg-white/90 px-4 py-3 shadow-sm backdrop-blur-xl md:min-h-20 md:px-6">
